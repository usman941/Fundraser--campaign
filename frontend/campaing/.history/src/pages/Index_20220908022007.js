...
const Index = () => {
    ...
    const settingupcategory=()=>{setAllData(1)
    console.log('hi usman',allData)}
  return (
    <>
    <HomeWrapper>
        {/* Filter Section */}
        ...
        <Category onClick={()=>{settingupcategory()}} >Health</Category>
        <Category onClick={()=>{setCategory('2')}}>Education</Category>
        <Category onClick={()=>{setCategory('3')}}>Animal</Category>
        </FilterWrapper>
        {/* Cards Container */}
