...
// Starting health campaign
    ...
    //   Starting Education campaign
      ...
      console.log("Health Data campains:", EducationCampaigns);
      setHealthDataState(EducationCampaigns);
    ...
    const getAnimalCampaigns = contract.filters.campaignCreated(
      ...
      console.log("Health Data campains:", AnimalCampaigns);
      setHealthDataState(AnimalCampaigns);
