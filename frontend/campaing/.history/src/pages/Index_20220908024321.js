...
const Index = () => {
    ...
    const settingupcategory=(i)=>{setMyCategory(i)
  ...
  return (
    ...
    <HomeWrapper>
        ...
        <Category onClick={()=>{settingupcategory(1)}} >Health</Category>
        <Category onClick={()=>{settingupcategory(2)}}>Education</Category>
        <Category onClick={()=>{settingupcategory(3)}}>Animal</Category>
        </FilterWrapper>
        {/* Cards Container */}
        <div className='CardWrapper'>
            ...
            {/* Cards */}
          {
            category==='1'?setAllData(HealthDataState):
            category==='2'?setAllData(EducationDataState):
            category==='3'?setAllData(AnimalDataState):''
    ...
    allData.map((e,index)=>
            <Card >
                ...
                <CardData>
                    ...
                    <Text>{ethers.utils.formatEther(e.args.fundAmount)}</Text>
