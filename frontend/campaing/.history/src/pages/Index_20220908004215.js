...
const Index = () => {
  ...
  return (
    ...
    <HomeWrapper>
        ...
        <Category onClick={()=>HealthDataState} >Health</Category>
        <Category onClick={()=>EducationDataState}>Education</Category>
        <Category onClick={()=>AnimalDataState}>Animal</Category>
        </FilterWrapper>
        {/* Cards Container */}
